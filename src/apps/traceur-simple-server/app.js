...
try {
	// Constant definition
	const MY_CONST = 1;
	console.info('»»» Constant usage supported by traceur.'.green);
} catch(e) {
	console.error('[x] Constant usage not supported by traceur.'.red);
}
...
try {
	...
	if(i > j) {
		let j = 100;
		if(j > i) {
			console.info('»»» Block scope variable supported by traceur.'.green);
		}
	}
} catch(e) {
	console.error('[x] Block scope not supported by traceur.'.red);
}
...
try {
	...
	for(let i = 0; i < 10; i++) {}
	if(i === 1) {
		console.info('»»» Block scope variable in loop supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Block scope variable in loop not supported by traceur.'.red);
}
...
try {
	...
	if(f(2) === 4 && ff(1, 1) === 4 && fff(1, 1, 2) === 3 && ffff([1, 1, 2]) === 4) {
		console.info('»»» Arrow function supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Arrow function not supported by traceur.'.red);
}
...
try {
	var Person = function(birthdate){
	    ...
	    if(this.age() > 18) {
	    	console.info('»»» Arrow function with this reference supported by traceur.'.green);
	    }
	};

	var me = new Person('1972-02-21 01:00:00');
} catch(e) {
	console.error('[x] Arrow function with this reference not supported by traceur.'.red);
}
...
try {
	...
	if(f(2) === 14) {
		console.info('»»» Function with default parameter value supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Function with default parameter value not supported by traceur.'.red);
}
...
try {
	...
	if(f(1, 2, 3) === 6 && f(...[1, 2, 3]) === 6) {
		console.info('»»» Function with variable number of parameters supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Function with variable number of parameters not supported by traceur.'.red);
}
...
try {
	...
	console.info('»»» Template string supported by traceur.'.green);
} catch(e) {
	console.error('[x] Template string not supported by traceur.');
}
...
try {
	...
	if(a === 2 && b === 3 && c == a && d == b && e == a && f == b && g == 5 && h == a && i == b) {
		console.info('»»» Destructuring assignment for array supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Destructuring assignment for array not supported by traceur.'.red);
}
...
try {
	...
	if(a === 1 && b === 2 && c == a && d == b && e == a && f == b && x == 3 && y == 21) {
		console.info('»»» Destructuring assignment for object supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Destructuring assignment for object not supported by traceur.'.red);
}
...
try {
	...
	get().then(function(v){
		console.info('»»» Promise supported by traceur.'.green);
	});
} catch(e) {
	console.error('[x] Promise not supported by traceur.'.red);
}
...
try {
	...
	if(player.y === 34) {
		console.info('»»» Basic POO supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Basic POO not supported by traceur.'.red);
}
...
try {
	let me = new Human({
		name: 'Frederic GINIOUX'
	});

	if(me instanceof Human) {
		console.info('»»» Module supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Module not supported by traceur.'.red);
}
...
try {
	...
	var t = p.a;
	if(t === 20) {
		console.info('»»» Proxy supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Proxy not supported by traceur.'.red);
}
...
try {
	...
	// Array conversion
	let w = [...s];
	console.info('»»» Set object supported by traceur.'.green);
} catch(e) {
	console.error('[x] Set object not supported by traceur.'.red);
}
...
try {
	...
	console.info('»»» Map object supported by traceur.'.green);
} catch(e) {
	console.error('[x] Map object not supported by traceur.'.red);
}
...
try {
	...
	console.info('»»» Array.from method supported by traceur.'.green);
} catch(e) {
	console.error('[x] Array.from method not supported by traceur.'.red);
}

try {
	let f = [1, 2, 3, 4].find((x) => { return x > 2; });
	if(f) {
		console.info('»»» Array.prototype.find method supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Array.prototype.find method not supported by traceur.'.red);
}

try {
	let f = [1, 2, 3, 4].findIndex((x) => { return x > 2; });
	if(f) {
		console.info('»»» Array.prototype.findIndex method supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Array.prototype.findIndex method not supported by traceur.'.red);
}
...
try {
	...
	if(Number.isInteger(i) && !Number.isNaN(ii) && Number.isNaN(NaN) && Number.isSafeInteger(i) && !Number.isSafeInteger(ii)) {
		console.info('»»» Number new methods (isInteger, isNaN, isSafeInteger) supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Number new methods (isInteger, isNaN, isSafeInteger) not supported by traceur.'.red);
}
...
try {
	...
	console.info('»»» Object syntax supported by traceur.'.green);
} catch(e) {
	console.error('[x] Object syntax not supported by traceur.'.red);
}
...
try {
	...
	o.values = {a: 10, b: 1};
	if(o.a == 10) {
		console.info('»»» Object assessors supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Object assessors not supported by traceur.'.red);
}
...
try {
	...
	if(g.indexOf(2) === 0 && g.indexOf(3) === 1) {
		console.info('»»» Generators supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Generators not supported by traceur.'.red);
}
...
try {
	...
	if(p.length === 10 && pSet.has('poodle')) {
		console.info('»»» Iterators supported by traceur.'.green);
	}
} catch(e) {
	console.error('[x] Iterators not supported by traceur.'.red);
}